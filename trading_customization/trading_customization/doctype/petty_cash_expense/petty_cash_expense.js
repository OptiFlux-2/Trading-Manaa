...
frappe.ui.form.on("Petty Cash Expense", {
	...
	from_date(frm) {
		validate_petty_cash_dates(frm, "from_date");
	},

	to_date(frm) {
		validate_petty_cash_dates(frm, "to_date");
	},
...
frappe.ui.form.on("Petty Cash Expense Invoice", {
	invoices_remove(frm) {
...
function validate_petty_cash_dates(frm, changed_field) {
